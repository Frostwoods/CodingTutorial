...
def main():
    ...
    print('Normal trial:', 'human:', humanGoalCommitMeanNormal, 'max:', maxGoalCommitMeanNormal, 'softmax:',
          softmaxGoalCommitMeanNormal)
    print('Specail trial:', 'human:', humanGoalCommitMeanSpecail, 'max:', maxGoalCommitMeanSpecail, 'softmax:',
