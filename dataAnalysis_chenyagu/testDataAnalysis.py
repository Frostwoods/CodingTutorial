...
class TestAnalysisFunctions(unittest.TestCase):
    ...
    @data((('1000, 2000, 3000, 4000'), '[1,2]', 1), \
          ...
          (('10, 15, 25, 40'), ('[1]'), 0))
    @unpack
    def testCalculateIsTimeMaxNextNoise(self, timeList, noisePoint, groundTruthStep):
        # pass
        isTimeMaxNextNoise = calculateIsTimeMaxNextNoise(timeList, noisePoint)
        truthValue = np.array_equal(isTimeMaxNextNoise, groundTruthStep)
        self.assertTrue(truthValue)
