...
def main():
    ...
    print('Normal trial:', 'human:', humanFirstIntentStepRatioMeanNormal, 'max:', maxFirstIntentStepRatioMeanNormal,
          'softmax:', softmaxFirstIntentStepRatioMeanNormal)
    print('Specail trial:', 'human:', humanFirstIntentStepRatioMeanSpecail, 'max:', maxFirstIntentStepRatioMeanSpecail,
          'softmax:', softmaxFirstIntentStepRatioMeanSpecail)
